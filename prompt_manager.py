...
class PromptManager:
    ...
    def __init__(self, user_topic: str, config: PodcastConfig = None):
        self.user_topic = user_topic
        self.config = config or PodcastConfig()  # Default config
    ...
    def get_outliner_prompt(self, blueprint: Dict, research: Dict, topic: str) -> str:
